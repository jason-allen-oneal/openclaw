...
const MODEL_DEFINITIONS = [
  {
    id: "gemini-3-flash",
    name: "Gemini 3 Flash through Antigravity",
    reasoning: false,
  },
  {
    id: "gemini-3-pro-low",
    name: "Gemini 3 Pro Low through Antigravity",
    reasoning: true,
  },
  {
    id: "gemini-3-pro-high",
    name: "Gemini 3 Pro High through Antigravity",
    reasoning: true,
  },
] as const;
...
export function buildGoogleAntigravityProvider(
  ...
  return {
    ...
    label: "Google Antigravity (experimental)",
    ...
    wizard: {
      setup: {
        ...
        choiceLabel: "Google Antigravity (experimental)",
